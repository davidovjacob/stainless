...
export function getRuntime({ manuallyImported }: { manuallyImported?: boolean } = {}): Shims {
  const recommendation =
    ...
    : `Add one of these imports before your first \`import … from 'https://github.com/davidovjacob/stainless'\`:
...
`;
  ...
  return {
    ...
    fileFromPath: () => {
      throw new Error(
        'The `fileFromPath` function is only supported in Node. See the README for more details: https://www.github.com/stainless-sdks/personal-5t7qa0/jacob-node#file-uploads',
      );
    },
